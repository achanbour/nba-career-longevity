...
We are then able to see that there is a slight difference in distribution of positions between those who made 5 years and those who didn't.

We conclude that both these variables are likely to be relevant.
...
The chosen predictors have p-value below 0.05 aned capture the most prominent factors affecting the performance of a player in the NBA.
