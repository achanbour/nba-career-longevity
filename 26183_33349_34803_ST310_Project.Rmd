...
LASSO suggests: "GP"", "MIN", "PTS", "FG.", "FTM", "OREB", "AST", "BLK", "Win_Perc", "Round_Drafted_X1", "Position_Point.guard", "Round_Drafted_1_before_1989"
...
```{r knn}
vars_lasso_output <- c("GP", "MIN", "PTS", "FG.", "FTM", "OREB", "AST", "BLK", "Win_Perc", "Round_Drafted_X1", "Position_Point.guard", "Round_Drafted_1_before_1989")
...
KNN yields an accuracy of nearly 76%, which is quite high considering it is a simple model. This suggests the LASSO variable selection worked well.
