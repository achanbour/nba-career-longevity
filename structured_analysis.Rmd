...
Using tidymodels "step_dummy_multi_choice" function, create dummy columns for the two categoric variables (Round Drafted and Position)
...
dummy_multi_choice_rec <- recipe(~ ., data = data) %>%
  step_dummy_multi_choice(Round_Drafted, "Position") %>%
  prep()
