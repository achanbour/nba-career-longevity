...
Yes, the additivity assumption of GAMs means the model's predictions cannot possibly depend on interactions
...
Additivity on the log-odds scale does not transform into additivity on the response scale, so in terms of the predicted probabilities the model does appear to depend on interactions between predictors and not just additively
